...
const FixedImagesTop = () => {
  return (
    <div className='top-frame framing-imgs'>
        ...
        <div className="fixed-image top-right">
        <img id='top-right-1'src="/Shapes/BluePurpleCross.png" alt="" />
            <img id='top-right-2' src="/Shapes/BluePurpleCross.png" alt="" />
        </div>
